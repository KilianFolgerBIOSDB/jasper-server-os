...
//			formObject.setReportDataSource(newReportDataSource(dsType, ds));
    ...
    protected void initBinder(RequestContext requestContext, DataBinder binder) {
		...
		binder.setAllowedFields(
				...
				"reportDataSource.label",
				"reportDataSource.description",
				"reportDataSource.parentFolder",
				"reportDataSource.driverClass",
				"reportDataSource.connectionUrl",
				"reportDataSource.username",
				"reportDataSource.password",
				"reportDataSource.jndiName",
				"reportDataSource.beanName",
				"reportDataSource.beanMethod",
				"reportDataSource.timezone",
				"reportDataSource.propertyMap[*]"
		);
    }
